...
def get_options() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--plasmid-genes", dest="plasmid_genes", help=argparse.SUPPRESS, required=False, default=None
    )
...
def main() -> None:
    ...
    AMR_gene_reference_FASTA, sequence_names, core_genes, plasmid_genes = load_species_specific_files(
