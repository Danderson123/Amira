...
class TestReadConstructor(unittest.TestCase):
    ...
    def test_gene_geneMers_size_1(self):
        ...
        self.assertTrue(actual_geneStrings == [['gene1'], ['gene2'], ['gene3'], ['gene4'], ['gene5']] or actual_geneStrings == list(reversed([['gene1'], ['gene2'], ['gene3'], ['gene4'], ['gene5']])))
    ...
    def test_gene_geneMers_size_2(self):
        ...
        self.assertEqual(actual_number_of_geneMers, expected_number_of_geneMers)
        self.assertTrue(all(any(test_gene[1:] in g for g in actual_geneStrings) for test_gene in annotatedGenes))
