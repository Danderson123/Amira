...
test_reverse_strand()
sys.stderr.write("Test passed\n")
sys.stderr.write("Testing construct_gene: convert_int_strand_to_string\n")
test_convert_int_strand_to_string()
sys.stderr.write("Test passed\n")
sys.stderr.write("Testing construct_gene: Gene.reverse_gene\n")
test_reverse_gene()
sys.stderr.write("Test passed\n")
sys.stderr.write("Testing construct_gene: Gene.__eq__\n")
test_eq_gene()
sys.stderr.write("Test passed\n")
sys.stderr.write("Testing construct_gene: Gene.__hash__\n")
test_hash_gene()
sys.stderr.write("Test passed\n")
